...
<div class="jarak">
	<div class="row">
			<?php
				...
				$query=mysql_query("SELECT * FROM barang INNER JOIN kategori ON barang.id_kategori=kategori.id_kategori ORDER BY barang.id_barang DESC");  
				...
				<div class="fh5co-post-entry">
					<article class="col-lg-3 col-md-3 col-sm-3 col-xs-6 col-xxs-12 animate-box" >
						<figure class="gallery">
							<a href="#" title="<?php echo $nama; ?>">
								<img src="img/img_upload/<?php echo $gambar ?>" alt="Image" class="img-responsive img-thumbnail"  style="height: 250px; width: 250px">
							</a>
						</figure>
