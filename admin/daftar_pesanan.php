...
<div style="margin-right: 10px;">
	<p class="text-center text-success" style="font-size:40px;font-weight: bold;">DATA PEMESANAN BARANG</p>
	<!-- <form action="proses_status.php" method="post" enctype="multipart/form-data"> -->
		<table id="list_pesan" class="display" width="100%">
			<thead>
				<tr>
					<th>No</th>
					<th>No Transaksi</th>
			...
			<tbody>
				<?php 
					...
					$no=1;
					$query=mysql_query("SELECT * FROM pembelian INNER JOIN user ON pembelian.usr_id=user.usr_id ORDER BY pembelian.bl_id DESC");
				...
				<tr>
					...
					<td>
						...
						<a href="?hal=detail_pemesanan&id=<?php echo $bl_id; ?>"><button class="btn btn-primary btn-block">DETAIL</button></a>
					</td>
