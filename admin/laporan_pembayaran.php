<div id="add_product" style="margin-top: 20px;" >
<h1 class="text-center text-primary">LAPORAN PEMBAYARAN</h1><br/>	
	<div style="margin-left: 24%;">
		<form action="proses_lpb.php" class="form-inline" method="post" enctype="multipart/form-data" id="form" target="_blank">
