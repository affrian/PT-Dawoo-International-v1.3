<div class="jarak">
	<div class="row">
			<?php
				...
				$query=mysql_query("SELECT * FROM barang INNER JOIN kategori ON barang.id_kategori=kategori.id_kategori WHERE kategori.id_kategori=2 ORDER BY barang.id_barang DESC");  
